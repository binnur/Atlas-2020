...
public class LED extends SpartronicsSubsystem {
     ...
     * - Use `$ lsusb -v` to get info on USB device - kPortDescription is used for
     * port enumeration - Since LED subsystem only 'write' to the port, writeBytes()
     * method is used TODO -- verify Arduino returns port description and matches
     * kPortDescription
     */
